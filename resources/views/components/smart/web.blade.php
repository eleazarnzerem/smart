...
<div>
    ...
    <main class="text-gray-900 mx-auto md:w-10/12">


        <section class="pt-20 md:pt-48 transition-all duration-300">
            <div class="container mx-auto px-2 lg:flex">
                <div class="text-center lg:text-left lg:w-1/2">
                    <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">Managed Analytics and Data
                        Analysis Platform</h1>
                    <p class="text-xl lg:text-2xl mt-6 font-light">We have created a cloud based tool to do your all
                        boring tasks related to data analysis and decesion making based on the nature of data!
                    </p>
                    <p class="mt-8 md:mt-12">
                        <button type="button"
                            class=" py-3 px-10 bg-[#e25c30] font-bold hover:bg-[#272424] rounded text-white transition-all duration-300">About
                            us</button>
                        <button type="button"
                            class=" py-3 px-10 border text-[#e25c30] font-bold border-[#e25c30] hover:bg-[#181e31] rounded hover:border-none hover:text-white transition-all duration-300">
                            Get Started</button>
                    </p>
                </div>
        ...
        <section id="features" class="py-20 lg:pb-40 lg:pt-48">
            <div class="container mx-auto text-center">
                ...
                <div class="flex flex-col space-y-5 md:space-y-0 sm:flex-row sm:-mx-3 mt-12 sm:justify-between sm:space-x-5">
                    <div class="flex-1 lg:max-w-[340px] px-3 flex justify-between flex-col space-y-5  group md:translate-y-20">
                        <div class="bg-[#e25c30] group-hover:bg-[#272424] inline-block py-6 px-6 rounded-md self-center lg:self-start transition-all duration-500">
                            <i class='bx bxs-analyse text-2xl text-white'></i>
                        </div>
                        <div class="lg:text-left">
                            <p class="font-bold text-2xl hover:text-[#e25c30] duration-700">Analyze Your Data Needs
                            </p>
                            <p class="mt-2 font-bold">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore..
                            </p>
                          </div>
                          <div class="flex self-center lg:self-start text-[#e25c30] group-hover:text-[#272424]">
                            <i class="bx bx-right-arrow-alt text-2xl  relative translate-x-0 group-hover:translate-x-[78px] transition-all duration-700"></i>
                            <a href="#" class="relative translate-x-0 group-hover:-translate-x-[20px] transition-all duration-700">Read More</a>
                        </div>
                    </div>
                    <div class="flex-1 lg:max-w-[340px] px-3 flex justify-center group flex-col space-y-5 md:translate-y-10">
                        <div class="bg-[#e25c30] group-hover:bg-[#272424] inline-block py-6 px-6 rounded-md self-center lg:self-start transition-all duration-500">
                            <i class='bx bxs-analyse text-2xl text-white'></i>
                        </div>
                        <div class="lg:text-left">
                    ...
                    <div class="flex-1 lg:max-w-[340px] px-3 flex justify-center flex-col space-y-5  group">
                        <div class="bg-[#e25c30] group-hover:bg-[#272424] inline-block py-6 px-6 rounded-md self-center lg:self-start transition-all duration-500">
                            <i class='bx bxs-analyse text-2xl text-white'></i>
                        </div>
                        <div class="lg:text-left">
        ...
        <section id="services" class="py-20">
            <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                <div class="bg-[#0a103d] w-2/4  py-[80px] px-[40px] trapeziod flex flex-col">
                  <div class="trapeziod2 flex flex-col space-y-8">
                    <p class="text-white font-bold text-4xl">Why Choose Us?</p>
                    <p class="text-white text-2xl">During 30 years in data analytics, we have built up comprehensive competencies that cover traditional and big data, data management, business intelligence (including self-service BI and data visualization), advanced data analytics, and data science.

                      In 2015, we were rated A+ by BBB, recognized as the top IT company by Clutch, as well as featured on The Silicon Review listing among 10 Fastest Growing Data Analytics Companies.</p>
            ...
            <div class="container mx-auto px-16 items-center flex flex-col lg:flex-row">
                ...
                <div class="mt-10 lg:mt-0 w-full lg:w-1/2 order-last lg:order-first">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1113.58 784.41">
                        <defs>
                            <linearGradient id="a" x1="990.77" y1="609.55" x2="1147.32"
                                y2="609.55" gradientTransform="matrix(-1 0 0 1 2040 0)"
                                gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="gray" stop-opacity=".25"></stop>
                                <stop offset=".54" stop-color="gray" stop-opacity=".12"></stop>
                                <stop offset="1" stop-color="gray" stop-opacity=".1"></stop>
                        ...
                        <ellipse cx="965" cy="767.42" rx="64" ry="16.99" fill="#4299e1"
                            opacity=".1"></ellipse>
                        <path
                        ...
                        <ellipse cx="233.68" cy="722.61" rx="18.68" ry="3.16" fill="#4299e1"
                            opacity=".1">
                        </ellipse>
                        <path
                        ...
                        <path
                            ...
                            opacity=".2"></path>
                        <ellipse cx="1063.8" cy="749.41" rx="34.31" ry="5.8" fill="#4299e1"
                            opacity=".1">
                        </ellipse>
                        <path
