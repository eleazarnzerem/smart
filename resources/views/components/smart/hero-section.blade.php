<div class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-[500px] text-white overflow-hidden md:h-[700px] lg:h-screen transition-all duration-300 ">
    ...
    <div class="relative z-10 flex flex-col justify-center items-center h-full text-center">
      <h1 class="text-5xl font-bold leading-tight mb-4">Welcome to SmartEdge Consulting & Analytics</h1>
      <p class="text-lg text-gray-300 mb-8">Empowering businesses with data-driven insights for informed decisions and competitive edge</p>
